module Internal
  module Commandable
    ...
    def fade(start_time:, end_time: nil, easing: Easing::Linear, start_opacity:, end_opacity: nil)
      Internal.assert_type!(start_time, Integer, "start_time")
      Internal.assert_type!(end_time, Integer, "end_time") if end_time
      ...
      Internal.assert_type!(end_opacity, [Float, Integer], "end_opacity") if end_opacity
    ...
    def move(start_time:, end_time: nil, easing: Easing::Linear, start_position:, end_position: nil)
      Internal.assert_type!(start_time, Integer, "start_time")
      Internal.assert_type!(end_time, Integer, "end_time") if end_time
      Internal.assert_type!(easing, Integer, "easing")
      Internal.assert_value!(easing, Easing::ALL, 'easing')
      Internal.assert_type!(start_position, Vector2, "start_position")
      Internal.assert_type!(end_position, Vector2, "end_position") if end_position

      end_time_ = '' if !end_time || start_time == end_time
      command = " M,#{start_time},#{end_time},#{start_position.x},#{start_position.y}"
    ...
    def scale(start_time:, end_time: nil, easing:, start_scale:, end_scale: nil)
      ...
      Internal.assert_type!(end_scale, [Float, Integer], "end_scale") if end_scale
    ...
    def vector_scale(start_time:, end_time: nil, easing: Easing::Linear, start_position:, end_scale: nil)
      Internal.assert_type!(start_time, Integer, "start_time")
      Internal.assert_type!(end_time, Integer, "end_time") if end_time
      Internal.assert_type!(easing, Integer, "easing")
      Internal.assert_value!(easing, Easing::ALL, 'easing')
    ...
    def rotate(start_time:, end_time: nil, easing: Easing::Linear, start_rotate:, end_rotate: nil)
      Internal.assert_type!(start_time, Integer, "start_time")
      Internal.assert_type!(end_time, Integer, "end_time") if end_time
      Internal.assert_type!(easing, Integer, "easing")
      Internal.assert_value!(easing, Easing::ALL, 'easing')
      Internal.assert_type!(start_rotate, [Float, Integer], "start_rotate")
      Internal.assert_type!(end_rotate, [Float, Integer], "end_rotate") if end_rotate
    ...
    def color(start_time:, end_time: nil, easing: Easing::Linear, start_color:, end_color: nil)
      Internal.assert_type!(start_time, Integer, "start_time")
      Internal.assert_type!(end_time, Integer, "end_time") if end_time
      Internal.assert_type!(easing, Integer, "easing")
      Internal.assert_value!(easing, Easing::ALL, 'easing')
      ...
      end_time_ = '' if !end_time || start_time == end_time
      command = " C,#{start_time},#{end_time},#{start_color.r},#{start_color.g},#{start_color.b}"
    ...
    def flip(start_time:, end_time:, horizontally: true, vertically: false)
      Internal.assert_type!(start_time, Integer, "start_time")
      Internal.assert_type!(end_time, Integer, "end_time")
      ...
      if horizontally && vertically
        raise ArgumentError, 'Only one can be true: horizontally, vertically'
      end
