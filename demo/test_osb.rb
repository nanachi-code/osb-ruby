...
bg = Osb::Background.new(file_path: "test.png")
...
sp.color(start_time: 0, start_color: Osb::Color.new(255, 255, 0))
sp.flip(start_time: 0, end_time: 1000, horizontally: true)
sp.additive_color_blending(start_time: 0, end_time: 1000)

sb << bg << sp

scene1 = Osb::Group.new
sp1 = Osb::Sprite.new(file_path: "test1.png")
sp1.trigger(on: "Passing", start_time: 0, end_time: 1000) do |it|
  ...
  it.color(start_time: 0, start_color: Osb::Color.new(255, 255, 0))
